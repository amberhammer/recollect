  ...
  return (
    ...
    <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg">
      ...
      <form className="flex flex-col gap-4">
        ...
        <input type="password" id="confirmPassword" name="confirmPassword" placeholder="Confirm Password" required className="border p-3 rounded-lg"/>
        <button className="bg-black text-white p-3 rounded-lg hover:bg-gray-800">Register</button>
      </form>
      <p className="text-sm text-gray-600 mt-4 text-center">Already have an account? <a href="/login" className="text-blue-500 hover:underline">Log in</a></p>
    </div>
  </div>
  );
}